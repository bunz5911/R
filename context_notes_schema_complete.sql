-- ============================================================================
-- 맥락 파악 학습 시스템 스키마 (완전한 버전)
-- Supabase SQL Editor에 복사해서 붙여넣고 실행하세요
-- ============================================================================

-- ============================================================================
-- 0. updated_at 자동 업데이트 함수 (이미 있으면 덮어씀)
-- ============================================================================
...
-- SELECT 정책: 사용자는 자신의 맥락 파악 내용만 조회 가능
...
-- INSERT 정책: 사용자는 자신의 맥락 파악 내용만 추가 가능
...
-- UPDATE 정책: 사용자는 자신의 맥락 파악 내용만 수정 가능
...
-- DELETE 정책: 사용자는 자신의 맥락 파악 내용만 삭제 가능
...
-- 완료!
-- ============================================================================
-- 실행 후 Table Editor에서 user_context_notes 테이블이 생성되었는지 확인하세요.
